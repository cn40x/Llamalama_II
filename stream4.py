...
def main():
    ...
    for message in st.session_state.messages:
        if message["role"] == "assistant":
            ...
            with col1:
                ...
                # Load and display the appropriate profile image for the character
            ...
            # Default layout for user message
    ...
    if prompt:
        ...
        # Append assistant message with the selected character
        ...
        if selected_character=="Aeliana":
            ...
            #audio_bytes = read_mp3_wave_to_bytes(selected_sound)
